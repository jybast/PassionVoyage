...
/**
 * Fichier src/Extensions/Doctrine/MatchAgainst.php
 * Permet une recherche FULLTEXT de un ou plusieurs mots dans un titre ou un contenu 
 * L'entité doit être indexée FULLTEXT
 */
